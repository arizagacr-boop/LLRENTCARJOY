...
<style>
    ...
    section[data-testid="stSidebar"] { background-color: #111111; border-right: 1px solid #c9a84433; }
    ...
    .kpi-card { background: #111111; border: 1px solid #c9a84433; border-top: 2px solid #c9a844; border-radius: 14px; padding: 1.2rem 1.4rem; margin-bottom: 0.5rem; }
    .kpi-card.green { border-top-color: #00cc88; background: #0d1a12; }
    .kpi-card.red { border-top-color: #ff3333; }
    .kpi-card.amber { border-top-color: #ffaa00; }
    .kpi-label { font-size: 12px; color: #c9a844; margin: 0 0 6px; letter-spacing: 0.5px; text-transform: uppercase; }
    ...
    .kpi-delta.neu { color: #c9a844; }
    .section-title { font-size: 13px; font-weight: 500; color: #c9a844; letter-spacing: 1px; text-transform: uppercase; margin: 0 0 1rem; padding-bottom: 8px; border-bottom: 1px solid #c9a84422; }
</style>
...
CA = "#c9a844"
TC = "#a0b4ff"
CAT_COLORS = ["#c9a844","#ff3333","#00cc88","#ffaa00","#aa44ff","#ff6699","#00ccff","#ff9933","#66ff99","#cc44ff"]

plt.rcParams.update({
    "figure.facecolor": BG, "axes.facecolor": BG,
    "axes.edgecolor": "#1a1aff33", "axes.labelcolor": TC,
    "xtick.color": TC, "ytick.color": TC,
    "text.color": TC, "grid.color": "#c9a84420",
...
# ── HEADER ─────────────────────────────────────────────────────────────────────
CAR_IMG = ""
st.markdown(f"""
<div style="background:linear-gradient(135deg,#0a0a0a 0%,#1a1a1a 100%);padding:1.8rem 2.5rem;border-radius:16px;margin-bottom:2rem;
     display:flex;align-items:center;gap:2rem;border:1px solid #c9a84433;border-top:2px solid #c9a844;">
  <div style="background:#ffffff;border-radius:12px;padding:10px 16px;flex-shrink:0;display:flex;align-items:center;justify-content:center;">
    <img src="data:image/png;base64,{CAR_IMG}" style="height:48px;object-fit:contain;display:block;">
  </div>
  <div>
